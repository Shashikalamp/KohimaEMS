...
public class AC_UserActivity1MT_022 extends TC_LoginTest_001  {
	@Test(groups ="AC_UserActivity1MT_022", priority=82)
	public void Clickon1MAdminUserActivitybutton() throws InterruptedException {
		...
		try {
			...
			Thread.sleep(2000);
			Uat.Clickon1Moption();
			System.out.println("User Activity  1Month button is clickable");
			Thread.sleep(2000);
			Uat.Clickon1Dtableoption();
			System.out.println("User Activity  1M Table button is clickable");
			Thread.sleep(2000);
			Uat.Clickon1DCSVoption();
			System.out.println("User Activity  1M CSV button is clickable");
			Thread.sleep(2000);
			Uat.Clickon1DPDFoption();
			System.out.println("User Activity  1M PDF button is clickable");
			Thread.sleep(2000);
	...
	@Test(groups ="AC_UserActivity1MT_022",priority=83)
	public void Clickon1MServiceUserActivitybutton() throws InterruptedException {
		AC_UserActivityTest Uat = new AC_UserActivityTest(driver);
		try {
			Thread.sleep(2000);
